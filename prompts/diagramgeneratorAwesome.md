...
description: >-
  ...
  the size of the output, should not include any styling, and with layoutneato,
  overlapfalse, node shaperectangle as parameters. The code should be valid,
  ...
  sense for an expert of that input.
